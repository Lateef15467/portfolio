...
export const metadata: Metadata = {
  title: 'Abdul Latif | Portfolio',
  description:
    'Check out modern and stylish porfolio of an experienced Web Developer Abdul Latif! Built using TypeScript, Next.js 14, Framaer Motion and Tailwind CSS.',
};
